...
This
[blog post](http://www.yegor256.com/2015/03/22/takes-1.19-web-framework.html)
...
Then, download [`takes-1.19-jar-with-dependencies.jar`][jar]
and compile your Java code:

```bash
javac -cp takes-1.19-jar-with-dependencies.jar App.java
```

Now, run it like this:

```bash
java -Dfile.encoding=UTF-8 -cp takes-1.19-jar-with-dependencies.jar:. App
```
...
[jar]: https://repo1.maven.org/maven2/org/takes/takes/1.19/takes-1.19-jar-with-dependencies.jar
